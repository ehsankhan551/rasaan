...
const HEADERS = ["name", "description", "price", "stock_qty", "image_url", "active"] as const;
...
export default function ImportExportBar({ shopId, products }: { shopId: string; products: Product[] }) {
  ...
  function handleFileChange(e: React.ChangeEvent<HTMLInputElement>) {
    ...
    reader.onload = () => {
      ...
      startTransition(async () => {
        const result = await bulkUpsertProducts(shopId, parsedRows);
        if (result) {
          setMessage(
